...
if(app_mode=="Home"):
    ...
    Our mission is to help you identify plant diseases efficiently. Please upload an image of a plant, and our system will analyze it to detect any signs of diseases. Together, let's protect our crops and ensure a healthier harvest!
    ...
    st.header("Disease Recoginition")
    ...
    if(st.button("Predict")):
        ...
        st.success("According to our Model it's a {}.".format(class_name[result_index]))